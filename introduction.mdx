...
* Download and register package

```bash
git clone https://gitlab.com/Hoangbim/openchat-js.git
cd openchat-js
yarn
yarn link
```

* In your project run `yarn link stream-chat`
...
* We got JWT token from Step 1, now we can use to connecting to Stream
